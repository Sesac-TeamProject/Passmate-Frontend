...
import { SettlementMobile } from "./settlement-mobile";
...
export function SettlementPage({
  ...
  return (
    <>
      ...
      />
      <main className="flex flex-col gap-6 px-9 py-7 max-md:hidden">
        <HeroBanner
          title="정산"
        ...
        <section className="flex items-center gap-4 rounded-[20px] border bg-card px-6 py-[18px]">
          ...
          <div className="flex min-w-0 flex-1 flex-col gap-0.5">
            ...
            <span className="text-label-md text-muted-foreground">
              정산 주기 · 환불 정책 · 사업소득 세금 신고(3.3% 원천징수) 는 확정 전 — 기획서 §13.5
              결정 항목
            </span>
          </div>
          <Link
