...
export const ANSWER_DETAIL_MOCK: QuestionDetail = {
  ...
  isCorrect: false,
  verdictLabel: "부분",
  myAnswer: REPORT_ESSAY_ANSWERS_MOCK[0].text,
  correctAnswer: "1차 캐시·동일성 보장·쓰기 지연·변경 감지를 든다.",
  explanation: null,
  analysis: {
    status: "DONE",
    keyPoints: ["1차 캐시와 동일성 보장을 짚었어요"],
    missingPoints: ["쓰기 지연·변경 감지를 언급하지 않았어요"],
    suggestions: ["flush 시점을 예시와 함께 보강해 보세요"],
    summary: "핵심 개념은 잡았고, 쓰기 지연·변경 감지를 더하면 모범답안에 가까워져요.",
  },
  teacherComment: null,
  distribution: [],
};
